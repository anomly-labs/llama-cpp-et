...
say(){ echo ">> $*"; }
say "apt deps"; # tools present on runpod images
...
say "model"; curl -sL -o /w/m.gguf https://huggingface.co/Anomly/qwen2.5-coder-0.5b-everywhere-exact-w8/resolve/main/student05_fixed8-bposit8.gguf
