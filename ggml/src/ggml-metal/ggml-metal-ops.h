...
// Anomly exact b-posit8 matmul: scratch for the quantised src1 (33 bytes per 32-element block)
size_t ggml_metal_op_mul_mat_bposit8_extra_tmp(const struct ggml_tensor * op);
