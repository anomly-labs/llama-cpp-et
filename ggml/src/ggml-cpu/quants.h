...
void quantize_row_bposit8(const float * GGML_RESTRICT x, void * GGML_RESTRICT y, int64_t k); // b-posit8 W8A8 (Anomly)
...
void ggml_vec_dot_bposit8_bposit8(int n, float * GGML_RESTRICT s, size_t bs, const void * GGML_RESTRICT vx, size_t bx, const void * GGML_RESTRICT vy, size_t by, int nrc); // b-posit8 W8A8 exact-quire (Anomly)
void ggml_vec_dot_bposit8_bposit8_scalar(int n, float * GGML_RESTRICT s, size_t bs, const void * GGML_RESTRICT vx, size_t bx, const void * GGML_RESTRICT vy, size_t by, int nrc); // scalar reference for the vector path's gate
