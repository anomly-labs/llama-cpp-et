...
GGML_API void quantize_row_bposit8_ref(const float * GGML_RESTRICT x, block_bposit8 * GGML_RESTRICT y, int64_t k); // b-posit8 W8A8 (Anomly)
...
GGML_API void dequantize_row_bposit8(const block_bposit8 * GGML_RESTRICT x, float * GGML_RESTRICT y, int64_t k); // b-posit8 W8A8 (Anomly)
